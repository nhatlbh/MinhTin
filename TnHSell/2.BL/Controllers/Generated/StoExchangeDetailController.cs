...
{
   public partial class StoExchangeDetailController: ApiController
    {
        StoExchangeDetailDT dta = new StoExchangeDetailDT();
        IBaseBR businessRule = BRFactory.GenerateBRObject(typeof(StoExchangeDetailBR));
        [Route("StoExchangeDetail/GetAll")]
        [HttpGet, HttpPost]
        ...
        [Route("StoExchangeDetail/GetGridData")]
        [HttpGet, HttpPost]
         public HttpResponseMessage GetGridData(string sessionKey,string cond = "", string order="")
        {
            try
            {
              return Request.CreateResponse<string>(HttpStatusCode.OK, JsonConvert.SerializeObject(dta.GetGridData(StoExchangeDetailDFR.GetGridData(sessionKey, cond, out order), order))); 
            }
            catch (Exception e)
            {
                ExceptionHandler.Log(e);
        ...
        [Route("StoExchangeDetail/GetByID")]
        [HttpGet, HttpPost]
        ...
        [Route("StoExchangeDetail/Delete")]
        [HttpGet, HttpPost]
        ...
        [Route("StoExchangeDetail/GetComboboxData")]
        [HttpGet, HttpPost]
        public HttpResponseMessage GetComboboxData(string sessionKey,string cond="", string order="")
        {
          try
            {
                string columns = "";
                cond = StoExchangeDetailDFR.GetComboboxData(sessionKey,out columns,cond, out order);
