...
{
   public partial class ProducttypeCustomerController: ApiController
    {
        ProducttypeCustomerDT dta = new ProducttypeCustomerDT();
        IBaseBR businessRule = BRFactory.GenerateBRObject(typeof(ProducttypeCustomerBR));
        [Route("ProducttypeCustomer/GetAll")]
        [HttpGet, HttpPost]
        ...
        [Route("ProducttypeCustomer/GetGridData")]
        [HttpGet, HttpPost]
         public HttpResponseMessage GetGridData(string sessionKey,string cond = "", string order="")
        {
            try
            {
              return Request.CreateResponse<string>(HttpStatusCode.OK, JsonConvert.SerializeObject(dta.GetGridData(ProducttypeCustomerDFR.GetGridData(sessionKey, cond, out order), order))); 
            }
            catch (Exception e)
            {
                ExceptionHandler.Log(e);
        ...
        [Route("ProducttypeCustomer/GetByID")]
        [HttpGet, HttpPost]
        ...
        [Route("ProducttypeCustomer/Save")]
        [HttpGet, HttpPost]
        ...
        [Route("ProducttypeCustomer/Delete")]
        [HttpGet, HttpPost]
        ...
        [Route("ProducttypeCustomer/GetComboboxData")]
        [HttpGet, HttpPost]
        public HttpResponseMessage GetComboboxData(string sessionKey,string cond="", string order="")
        {
          try
            {
                string columns = "";
                cond = ProducttypeCustomerDFR.GetComboboxData(sessionKey,out columns,cond, out order);
