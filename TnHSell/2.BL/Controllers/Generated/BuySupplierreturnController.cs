...
{
   public partial class BuySupplierreturnController: ApiController
    {
        BuySupplierreturnDT dta = new BuySupplierreturnDT();
        IBaseBR businessRule = BRFactory.GenerateBRObject(typeof(BuySupplierreturnBR));
        [Route("BuySupplierreturn/GetAll")]
        [HttpGet, HttpPost]
        ...
        [Route("BuySupplierreturn/GetGridData")]
        [HttpGet, HttpPost]
         public HttpResponseMessage GetGridData(string sessionKey,string cond = "", string order="")
        {
            try
            {
              return Request.CreateResponse<string>(HttpStatusCode.OK, JsonConvert.SerializeObject(dta.GetGridData(BuySupplierreturnDFR.GetGridData(sessionKey, cond, out order), order))); 
            }
            catch (Exception e)
            {
                ExceptionHandler.Log(e);
        ...
        [Route("BuySupplierreturn/GetByID")]
        [HttpGet, HttpPost]
        ...
        [Route("BuySupplierreturn/Delete")]
        [HttpGet, HttpPost]
        ...
        [Route("BuySupplierreturn/GetComboboxData")]
        [HttpGet, HttpPost]
        public HttpResponseMessage GetComboboxData(string sessionKey,string cond="", string order="")
        {
          try
            {
                string columns = "";
                cond = BuySupplierreturnDFR.GetComboboxData(sessionKey,out columns,cond, out order);
