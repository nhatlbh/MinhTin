...
{
   public partial class SelReceiveproductController: ApiController
    {
        SelReceiveproductDT dta = new SelReceiveproductDT();
        IBaseBR businessRule = BRFactory.GenerateBRObject(typeof(SelReceiveproductBR));
        [Route("SelReceiveproduct/GetAll")]
        [HttpGet, HttpPost]
        ...
        [Route("SelReceiveproduct/GetGridData")]
        [HttpGet, HttpPost]
        ...
        [Route("SelReceiveproduct/GetByID")]
        [HttpGet, HttpPost]
        ...
        [Route("SelReceiveproduct/Delete")]
        [HttpGet, HttpPost]
        ...
        [Route("SelReceiveproduct/GetComboboxData")]
        [HttpGet, HttpPost]
        public HttpResponseMessage GetComboboxData(string sessionKey,string cond="", string order="")
        {
          try
            {
                string columns = "";
                cond = SelReceiveproductDFR.GetComboboxData(sessionKey,out columns,cond, out order);
