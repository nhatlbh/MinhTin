...
{
    public partial class CatColorDT
    {
        string TableName = "Cat_Color";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Cat_Color.ID,Cat_Color.Code,Cat_Color.Name,Cat_Color.Description,Cat_Color.OrderNum 
                            
                            FROM " + TableName +   @" Cat_Color    "
                            + ") AS grd_Cat_Color  WHERE 1=1";
        ...
        {
            string query = @"SELECT Cat_Color.ID,Cat_Color.Code,Cat_Color.Name,Cat_Color.Description,Cat_Color.OrderNum FROM Cat_Color WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Cat_Color.ID,Cat_Color.Code,Cat_Color.Name,Cat_Color.Description,Cat_Color.OrderNum FROM Cat_Color WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
        ...
        /// <returns></returns>
        public string Insert(CatColorContract catcolor, SqlTransaction  tran = null)
        {
            DataTable dtResult = null;
            string query = string.Format(@"INSERT INTO Cat_Color
                                        VALUES ({0},{1},{2},{3})",
								
								(catcolor.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catcolor.Code.ToString() ) + "'" : "null").ToString(),
								(catcolor.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catcolor.Name.ToString() ) + "'" : "null").ToString(),
								(catcolor.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catcolor.Description.ToString() ) + "'" : "null").ToString(),
								(catcolor.Ordernum.Trim() != String.Empty ? catcolor.Ordernum.ToString() : "null").ToString());
        ...
        /// <returns></returns>
        public string Update(CatColorContract catcolor, SqlTransaction  tran = null)
        {
            string query = String.Format("UPDATE " + TableName + @" SET Code={0},Name={1},Description={2},OrderNum={3}
                            WHERE ID=" + catcolor.Id.ToString(),
								(catcolor.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catcolor.Code.ToString() ) + "'" : "null").ToString(),
								(catcolor.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catcolor.Name.ToString() ) + "'" : "null").ToString(),
								(catcolor.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catcolor.Description.ToString() ) + "'" : "null").ToString(),
								(catcolor.Ordernum.Trim() != String.Empty ? catcolor.Ordernum.ToString() : "null").ToString());                                               
