...
{
    public partial class CatGuaranteestatusDT
    {
        string TableName = "Cat_GuaranteeStatus";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Cat_GuaranteeStatus.ID,Cat_GuaranteeStatus.Code,Cat_GuaranteeStatus.Name,Cat_GuaranteeStatus.Description,Cat_GuaranteeStatus.OrderNum 
                            
                            FROM " + TableName +   @" Cat_GuaranteeStatus    "
                            + ") AS grd_Cat_GuaranteeStatus  WHERE 1=1";
        ...
        {
            string query = @"SELECT Cat_GuaranteeStatus.ID,Cat_GuaranteeStatus.Code,Cat_GuaranteeStatus.Name,Cat_GuaranteeStatus.Description,Cat_GuaranteeStatus.OrderNum FROM Cat_GuaranteeStatus WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Cat_GuaranteeStatus.ID,Cat_GuaranteeStatus.Code,Cat_GuaranteeStatus.Name,Cat_GuaranteeStatus.Description,Cat_GuaranteeStatus.OrderNum FROM Cat_GuaranteeStatus WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
        ...
        /// <returns></returns>
        public string Insert(CatGuaranteestatusContract catguaranteestatus, SqlTransaction  tran = null)
        {
            DataTable dtResult = null;
            string query = string.Format(@"INSERT INTO Cat_GuaranteeStatus
                                        VALUES ({0},{1},{2},{3})",
								
								(catguaranteestatus.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catguaranteestatus.Code.ToString() ) + "'" : "null").ToString(),
								(catguaranteestatus.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catguaranteestatus.Name.ToString() ) + "'" : "null").ToString(),
								(catguaranteestatus.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catguaranteestatus.Description.ToString() ) + "'" : "null").ToString(),
								(catguaranteestatus.Ordernum.Trim() != String.Empty ? catguaranteestatus.Ordernum.ToString() : "null").ToString());
        ...
        /// <returns></returns>
        public string Update(CatGuaranteestatusContract catguaranteestatus, SqlTransaction  tran = null)
        {
            string query = String.Format("UPDATE " + TableName + @" SET Code={0},Name={1},Description={2},OrderNum={3}
                            WHERE ID=" + catguaranteestatus.Id.ToString(),
								(catguaranteestatus.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catguaranteestatus.Code.ToString() ) + "'" : "null").ToString(),
								(catguaranteestatus.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catguaranteestatus.Name.ToString() ) + "'" : "null").ToString(),
								(catguaranteestatus.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catguaranteestatus.Description.ToString() ) + "'" : "null").ToString(),
								(catguaranteestatus.Ordernum.Trim() != String.Empty ? catguaranteestatus.Ordernum.ToString() : "null").ToString());                                               
            ...
            return catguaranteestatus.Id.ToString();
        }
