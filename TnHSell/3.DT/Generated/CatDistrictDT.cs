...
{
    public partial class CatDistrictDT
    {
        string TableName = "Cat_District";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Cat_District.ID,Cat_District.Code,Cat_District.Name,Cat_District.ProvinceID,Cat_District.Description,Cat_District.OrderNum 
                             , Cat_Province.Name as Cat_Province_Name
                            FROM " + TableName +   @" Cat_District   Left Join Cat_Province on  Cat_District.ProvinceID = Cat_Province.ID 
			  "
                            + ") AS grd_Cat_District  WHERE 1=1";
        ...
        {
            string query = @"SELECT Cat_District.ID,Cat_District.Code,Cat_District.Name,Cat_District.ProvinceID,Cat_District.Description,Cat_District.OrderNum FROM Cat_District WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Cat_District.ID,Cat_District.Code,Cat_District.Name,Cat_District.ProvinceID,Cat_District.Description,Cat_District.OrderNum FROM Cat_District WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
        ...
        /// <returns></returns>
        public string Insert(CatDistrictContract catdistrict, SqlTransaction  tran = null)
        {
            DataTable dtResult = null;
            string query = string.Format(@"INSERT INTO Cat_District
                                        VALUES ({0},{1},{2},{3},{4})",
								
								(catdistrict.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catdistrict.Code.ToString() ) + "'" : "null").ToString(),
								(catdistrict.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catdistrict.Name.ToString() ) + "'" : "null").ToString(),
								(catdistrict.Provinceid != null? catdistrict.Provinceid.ToString() : "null").ToString(),
								(catdistrict.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catdistrict.Description.ToString() ) + "'" : "null").ToString(),
								(catdistrict.Ordernum.Trim() != String.Empty ? catdistrict.Ordernum.ToString() : "null").ToString());
        ...
        /// <returns></returns>
        public string Update(CatDistrictContract catdistrict, SqlTransaction  tran = null)
        {
            string query = String.Format("UPDATE " + TableName + @" SET Code={0},Name={1},ProvinceID={2},Description={3},OrderNum={4}
                            WHERE ID=" + catdistrict.Id.ToString(),
								(catdistrict.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catdistrict.Code.ToString() ) + "'" : "null").ToString(),
								(catdistrict.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catdistrict.Name.ToString() ) + "'" : "null").ToString(),
								(catdistrict.Provinceid != null? catdistrict.Provinceid.ToString() : "null").ToString(),
								(catdistrict.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catdistrict.Description.ToString() ) + "'" : "null").ToString(),
            ...
            return catdistrict.Id.ToString();
        }
