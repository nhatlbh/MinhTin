...
{
    public partial class AdmRolecontextDT
    {
        string TableName = "Adm_RoleContext";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Adm_RoleContext.ID,Adm_RoleContext.ContextID,Adm_RoleContext.RoleID,Adm_RoleContext.Permission,Adm_RoleContext.OrderNum 
                             , Adm_Context.Name as Adm_Context_Name, Adm_Role.Name as Adm_Role_Name
                            FROM " + TableName +   @" Adm_RoleContext   Left Join Adm_Context on  Adm_RoleContext.ContextID = Adm_Context.ID 
			 Left Join Adm_Role on  Adm_RoleContext.RoleID = Adm_Role.ID 
			  "
                            + ") AS grd_Adm_RoleContext  WHERE 1=1";
        ...
        {
            string query = @"SELECT Adm_RoleContext.ID,Adm_RoleContext.ContextID,Adm_RoleContext.RoleID,Adm_RoleContext.Permission,Adm_RoleContext.OrderNum FROM Adm_RoleContext WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Adm_RoleContext.ID,Adm_RoleContext.ContextID,Adm_RoleContext.RoleID,Adm_RoleContext.Permission,Adm_RoleContext.OrderNum FROM Adm_RoleContext WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
        ...
        /// <returns></returns>
        public string Insert(AdmRolecontextContract admrolecontext, SqlTransaction  tran = null)
        {
            DataTable dtResult = null;
            string query = string.Format(@"INSERT INTO Adm_RoleContext
                                        VALUES ({0},{1},{2},{3})",
								
								(admrolecontext.Contextid != null? admrolecontext.Contextid.ToString() : "null").ToString(),
								(admrolecontext.Roleid != null? admrolecontext.Roleid.ToString() : "null").ToString(),
								(admrolecontext.Permission.Trim() != String.Empty ? admrolecontext.Permission.ToString() : "null").ToString(),
								(admrolecontext.Ordernum.Trim() != String.Empty ? admrolecontext.Ordernum.ToString() : "null").ToString());
        ...
        /// <returns></returns>
        public string Update(AdmRolecontextContract admrolecontext, SqlTransaction  tran = null)
        {
            string query = String.Format("UPDATE " + TableName + @" SET ContextID={0},RoleID={1},Permission={2},OrderNum={3}
                            WHERE ID=" + admrolecontext.Id.ToString(),
								(admrolecontext.Contextid != null? admrolecontext.Contextid.ToString() : "null").ToString(),
								(admrolecontext.Roleid != null? admrolecontext.Roleid.ToString() : "null").ToString(),
								(admrolecontext.Permission.Trim() != String.Empty ? admrolecontext.Permission.ToString() : "null").ToString(),
								(admrolecontext.Ordernum.Trim() != String.Empty ? admrolecontext.Ordernum.ToString() : "null").ToString());                                               
            ...
            return admrolecontext.Id.ToString();
        }
