...
{
    public partial class CatProductgroupDT
    {
        string TableName = "Cat_ProductGroup";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Cat_ProductGroup.ID,Cat_ProductGroup.Code,Cat_ProductGroup.Name,Cat_ProductGroup.Description,Cat_ProductGroup.OrderNum 
                            
                            FROM " + TableName +   @" Cat_ProductGroup    "
                            + ") AS grd_Cat_ProductGroup  WHERE 1=1";
        ...
        {
            string query = @"SELECT Cat_ProductGroup.ID,Cat_ProductGroup.Code,Cat_ProductGroup.Name,Cat_ProductGroup.Description,Cat_ProductGroup.OrderNum FROM Cat_ProductGroup WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Cat_ProductGroup.ID,Cat_ProductGroup.Code,Cat_ProductGroup.Name,Cat_ProductGroup.Description,Cat_ProductGroup.OrderNum FROM Cat_ProductGroup WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
        ...
        /// <returns></returns>
        public string Insert(CatProductgroupContract catproductgroup, SqlTransaction  tran = null)
        {
            DataTable dtResult = null;
            string query = string.Format(@"INSERT INTO Cat_ProductGroup
                                        VALUES ({0},{1},{2},{3})",
								
								(catproductgroup.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproductgroup.Code.ToString() ) + "'" : "null").ToString(),
								(catproductgroup.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproductgroup.Name.ToString() ) + "'" : "null").ToString(),
								(catproductgroup.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproductgroup.Description.ToString() ) + "'" : "null").ToString(),
								(catproductgroup.Ordernum.Trim() != String.Empty ? catproductgroup.Ordernum.ToString() : "null").ToString());
        ...
        /// <returns></returns>
        public string Update(CatProductgroupContract catproductgroup, SqlTransaction  tran = null)
        {
            string query = String.Format("UPDATE " + TableName + @" SET Code={0},Name={1},Description={2},OrderNum={3}
                            WHERE ID=" + catproductgroup.Id.ToString(),
								(catproductgroup.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproductgroup.Code.ToString() ) + "'" : "null").ToString(),
								(catproductgroup.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproductgroup.Name.ToString() ) + "'" : "null").ToString(),
								(catproductgroup.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproductgroup.Description.ToString() ) + "'" : "null").ToString(),
								(catproductgroup.Ordernum.Trim() != String.Empty ? catproductgroup.Ordernum.ToString() : "null").ToString());                                               
            ...
            return catproductgroup.Id.ToString();
        }
