...
{
    public partial class CatReceipttypeDT
    {
        string TableName = "Cat_ReceiptType";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Cat_ReceiptType.ID,Cat_ReceiptType.Code,Cat_ReceiptType.Name,Cat_ReceiptType.Description,Cat_ReceiptType.Type,Cat_ReceiptType.OrderNum 
                            
                            FROM " + TableName +   @" Cat_ReceiptType    "
                            + ") AS grd_Cat_ReceiptType  WHERE 1=1";
        ...
        {
            string query = @"SELECT Cat_ReceiptType.ID,Cat_ReceiptType.Code,Cat_ReceiptType.Name,Cat_ReceiptType.Description,Cat_ReceiptType.Type,Cat_ReceiptType.OrderNum FROM Cat_ReceiptType WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Cat_ReceiptType.ID,Cat_ReceiptType.Code,Cat_ReceiptType.Name,Cat_ReceiptType.Description,Cat_ReceiptType.Type,Cat_ReceiptType.OrderNum FROM Cat_ReceiptType WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
        ...
        /// <returns></returns>
        public string Insert(CatReceipttypeContract catreceipttype, SqlTransaction  tran = null)
        {
            DataTable dtResult = null;
            string query = string.Format(@"INSERT INTO Cat_ReceiptType
                                        VALUES ({0},{1},{2},{3},{4})",
								
								(catreceipttype.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catreceipttype.Code.ToString() ) + "'" : "null").ToString(),
								(catreceipttype.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catreceipttype.Name.ToString() ) + "'" : "null").ToString(),
								(catreceipttype.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catreceipttype.Description.ToString() ) + "'" : "null").ToString(),
								(catreceipttype.Type.Trim() != String.Empty ? catreceipttype.Type.ToString() : "null").ToString(),
								(catreceipttype.Ordernum.Trim() != String.Empty ? catreceipttype.Ordernum.ToString() : "null").ToString());
        ...
        /// <returns></returns>
        public string Update(CatReceipttypeContract catreceipttype, SqlTransaction  tran = null)
        {
            string query = String.Format("UPDATE " + TableName + @" SET Code={0},Name={1},Description={2},Type={3},OrderNum={4}
                            WHERE ID=" + catreceipttype.Id.ToString(),
								(catreceipttype.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catreceipttype.Code.ToString() ) + "'" : "null").ToString(),
								(catreceipttype.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catreceipttype.Name.ToString() ) + "'" : "null").ToString(),
								(catreceipttype.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catreceipttype.Description.ToString() ) + "'" : "null").ToString(),
								(catreceipttype.Type.Trim() != String.Empty ? catreceipttype.Type.ToString() : "null").ToString(),
            ...
            return catreceipttype.Id.ToString();
        }
