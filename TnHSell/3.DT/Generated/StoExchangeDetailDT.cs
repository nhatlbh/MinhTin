...
{
    public partial class StoExchangeDetailDT
    {
        string TableName = "Sto_Exchange_Detail";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Sto_Exchange_Detail.ID,Sto_Exchange_Detail.ExchangeID,Sto_Exchange_Detail.ProductID,Sto_Exchange_Detail.Quantity,Sto_Exchange_Detail.OrderNum,Sto_Exchange_Detail.Deleted,convert(varchar(10),Sto_Exchange_Detail.DeletedOn,103) as DeletedOn 
                             , Cat_Product.Name as Cat_Product_Name , Sto_Exchange.Code as Sto_Exchange_Name
                            FROM " + TableName +   @" Sto_Exchange_Detail   Left Join Cat_Product on  Sto_Exchange_Detail.ProductID = Cat_Product.ID 
			 Left Join Sto_Exchange on  Sto_Exchange_Detail.ExchangeID = Sto_Exchange.ID 
			  "
                            + ") AS grd_Sto_Exchange_Detail  WHERE 1=1";
        ...
        {
            string query = @"SELECT Sto_Exchange_Detail.ID,Sto_Exchange_Detail.ExchangeID,Sto_Exchange_Detail.ProductID,Sto_Exchange_Detail.Quantity,Sto_Exchange_Detail.OrderNum,Sto_Exchange_Detail.Deleted,convert(varchar(10),Sto_Exchange_Detail.DeletedOn,103) as DeletedOn FROM Sto_Exchange_Detail WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Sto_Exchange_Detail.ID,Sto_Exchange_Detail.ExchangeID,Sto_Exchange_Detail.ProductID,Sto_Exchange_Detail.Quantity,Sto_Exchange_Detail.OrderNum,Sto_Exchange_Detail.Deleted,convert(varchar(10),Sto_Exchange_Detail.DeletedOn,103) as DeletedOn FROM Sto_Exchange_Detail WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
