...
{
    public partial class CatProducttypeDT
    {
        string TableName = "Cat_ProductType";
        /// <summary>
        ...
        public DataTable GetGridData(string cond, string order="", SqlTransaction  tran = null )
        {
            string query = @"SELECT * FROM (
                            SELECT 
                            Cat_ProductType.ID,Cat_ProductType.Code,Cat_ProductType.Name,Cat_ProductType.Description,Cat_ProductType.OrderNum 
                            
                            FROM " + TableName +   @" Cat_ProductType    "
                            + ") AS grd_Cat_ProductType  WHERE 1=1";
        ...
        {
            string query = @"SELECT Cat_ProductType.ID,Cat_ProductType.Code,Cat_ProductType.Name,Cat_ProductType.Description,Cat_ProductType.OrderNum FROM Cat_ProductType WHERE ID = " + id;
            DataTable dt = DataProvider.ExecuteQuery(query);
            return dt;
        }
        /// <summary>
        ...
        {
            string query = @"SELECT Cat_ProductType.ID,Cat_ProductType.Code,Cat_ProductType.Name,Cat_ProductType.Description,Cat_ProductType.OrderNum FROM Cat_ProductType WHERE 1=1 ";
            if (cond != null && cond != string.Empty)
            {
                query += " and " + cond;
            };
        ...
        /// <returns></returns>
        public string Insert(CatProducttypeContract catproducttype, SqlTransaction  tran = null)
        {
            DataTable dtResult = null;
            string query = string.Format(@"INSERT INTO Cat_ProductType
                                        VALUES ({0},{1},{2},{3})",
								
								(catproducttype.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproducttype.Code.ToString() ) + "'" : "null").ToString(),
								(catproducttype.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproducttype.Name.ToString() ) + "'" : "null").ToString(),
								(catproducttype.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproducttype.Description.ToString() ) + "'" : "null").ToString(),
								(catproducttype.Ordernum.Trim() != String.Empty ? catproducttype.Ordernum.ToString() : "null").ToString());
        ...
        /// <returns></returns>
        public string Update(CatProducttypeContract catproducttype, SqlTransaction  tran = null)
        {
            string query = String.Format("UPDATE " + TableName + @" SET Code={0},Name={1},Description={2},OrderNum={3}
                            WHERE ID=" + catproducttype.Id.ToString(),
								(catproducttype.Code.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproducttype.Code.ToString() ) + "'" : "null").ToString(),
								(catproducttype.Name.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproducttype.Name.ToString() ) + "'" : "null").ToString(),
								(catproducttype.Description.Trim() != String.Empty? "N'" + SQLHelper.RejectInjection( catproducttype.Description.ToString() ) + "'" : "null").ToString(),
								(catproducttype.Ordernum.Trim() != String.Empty ? catproducttype.Ordernum.ToString() : "null").ToString());                                               
            ...
            return catproducttype.Id.ToString();
        }
