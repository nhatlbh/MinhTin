...
<%@ Register Src="~/UC/Override/FinMoneyslip_Form.ascx" TagPrefix="uc1" TagName="FinMoneyslip_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
         ...
         <div class="title">Phiếu chi</div>
            <div id="search" class="jumbotron">
             <div class="row"><div class="label col-md-1">Mã:</div>
                        ...
                        </div><div class="label col-md-1">Loại chi:</div>
                        <div class="input col-md-3">
                        <input placeholder="--- Chọn ---" ID="ddlPaymenttypeid_S" />
        ...
        <div id="popup">
            <uc1:FinMoneyslip_Form runat="server" ID="FinMoneyslip_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Override/Page/FinMoneyslip_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Override/Page/FinMoneyslip_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
