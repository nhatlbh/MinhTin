...
<%@ Register Src="~/UC/Override/SelReceiveproduct_Form.ascx" TagPrefix="uc1" TagName="SelReceiveproduct_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
         <div class="title">Phiếu nhận hàng trả</div>
            <div id="search" class="jumbotron">
             <div class="row"><div class="label col-md-1">Mã:</div>
                        <div class="input col-md-3">
                            <input type="text" id="txtCode_S" />
                        </div><div class="label col-md-1">Phiếu bán hàng:</div>
                        <div class="input col-md-3">
                        <input placeholder="--- Chọn ---" ID="ddlInvoiceid_S" />
        ...
        <div id="popup">
            <uc1:SelReceiveproduct_Form runat="server" ID="SelReceiveproduct_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Override/Page/SelReceiveproduct_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Override/Page/SelReceiveproduct_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
