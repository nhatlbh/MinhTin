...
<%@ Register Src="~/UC/Override/FinReceipt_Form.ascx" TagPrefix="uc1" TagName="FinReceipt_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
         ...
         <div class="title">Phiếu thu</div>
            <div id="search" class="jumbotron">
             <div class="row"><div class="label col-md-1">Mã:</div>
                        ...
                        </div><div class="label col-md-1">Loại thu:</div>
                        <div class="input col-md-3">
        ...
        <div id="popup">
            <uc1:FinReceipt_Form runat="server" ID="FinReceipt_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Override/Page/FinReceipt_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Override/Page/FinReceipt_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
