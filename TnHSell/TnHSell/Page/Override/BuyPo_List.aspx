...
<%@ Register Src="~/UC/Override/BuyPo_Form.ascx" TagPrefix="uc1" TagName="BuyPo_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
        ...
        <div id="popup">
            <uc1:BuyPo_Form runat="server" ID="BuyPo_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Override/Page/BuyPo_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Override/BuyPo_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
