...
<%@ Register Src="~/UC/Generated/CatUnit_Form.ascx" TagPrefix="uc1" TagName="CatUnit_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
        ...
        <div id="popup">
            <uc1:CatUnit_Form runat="server" ID="CatUnit_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Generated/Page/CatUnit_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Generated/Page/CatUnit_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
