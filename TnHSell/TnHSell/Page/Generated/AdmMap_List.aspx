...
<%@ Register Src="~/UC/Generated/AdmMap_Form.ascx" TagPrefix="uc1" TagName="AdmMap_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
        ...
        <div id="popup">
            <uc1:AdmMap_Form runat="server" ID="AdmMap_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Generated/Page/AdmMap_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Generated/Page/AdmMap_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
