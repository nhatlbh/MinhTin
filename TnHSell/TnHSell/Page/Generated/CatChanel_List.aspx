...
<%@ Register Src="~/UC/Generated/CatChanel_Form.ascx" TagPrefix="uc1" TagName="CatChanel_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
        ...
        <div id="popup">
            <uc1:CatChanel_Form runat="server" ID="CatChanel_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Generated/Page/CatChanel_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Generated/Page/CatChanel_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
