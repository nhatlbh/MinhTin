...
<%@ Register Src="~/UC/Generated/CatSupplier_Form.ascx" TagPrefix="uc1" TagName="CatSupplier_Form" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row">
        ...
        <div id="popup">
            <uc1:CatSupplier_Form runat="server" ID="CatSupplier_Form" />
        </div>

<input type="hidden" id="hdfId" />
    <script type="text/javascript" src="../../Script/Generated/Page/CatSupplier_List.js?session='<%=Guid.NewGuid() %>'"></script>
    <script type="text/javascript" src="../../Script/Generated/Page/CatSupplier_Page.js?session='<%=Guid.NewGuid() %>'"></script>
</asp:Content>
