...
$('#txtDevname').val(uiObj[0].DevName);
$('#ddlMapid').data('kendoComboBox').value(uiObj[0].MapID ? uiObj[0].MapID : '');
$('#txtType').val(numberFormat(uiObj[0].Type));
$('#txtRootmap').val(numberFormat(uiObj[0].RootMap));
...
{ field: 'DevName', title: 'DevName'},
{ field: 'Adm_Map_Name', title: 'MapID'},
{ field: 'Type', title: 'Type'},
{ field: 'RootMap', title: 'RootMap'},
            ],
            selectable: 'row',
            scrollable:true,
