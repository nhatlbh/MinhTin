    ...
    <script type="text/javascript" src="../../Script/Generated/Form/CatProductPrice_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
      <div class="row"> 
   <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">IOCodeID:</div>
                        <div class="input col-md-8">
