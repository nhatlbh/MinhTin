    ...
    <script type="text/javascript" src="../../Script/Generated/Form/CatCustomer_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
      <div class="row"> 
   <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="label col-md-2">Nhóm quản lý:</div>
                        <div class="input col-md-8">
                        <input placeholder="--- Chọn ---" ID="ddlManagementgroupid" />
                        </div>
                    </div>    
                    <div class="row">
                        <div class="label col-md-2">Quận-Huyện:</div>
                        <div class="input col-md-8">
                        <input placeholder="--- Chọn ---" ID="ddlDistrictid" />
                        </div>
                    </div>    
                    <div class="row">
                        <div class="label col-md-2 required">Tỉnh:</div>
                        <div class="input col-md-8">
                        <input placeholder="--- Chọn ---" ID="ddlProvinceid" />
                        </div>
                    </div>    
                    <div class="row">
                        <div class="label col-md-2 required">Nhân viên sale:</div>
                        <div class="input col-md-8">
                    ...
                    <div class="row">
                        <div class="label col-md-2">Địa chỉ giao hàng:</div>
                    <div class="input col-md-8">
                        <textarea  id='txtDiliveraddress'  rows='3'></textarea>
                    </div>
                    </div>    
                    <div class="row">
