    ...
    <script type="text/javascript" src="../../Script/Generated/Form/AdmMap_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
      <div class="row"> 
   <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="label col-md-2">Path:</div>
                        <div class="input col-md-8">
                            <input type="text" id="txtPath" />
                        </div>
                    </div>    
                    <div class="row">
                        <div class="label col-md-2">ParentID:</div>
                        <div class="input col-md-8">
                        <input placeholder="--- Chọn ---" ID="ddlParentid" />
                        </div>
                    </div>    
                    <div class="row">
                        <div class="label col-md-2">PathLevel:</div>
                        <div class="input col-md-8">
                            <input type="text" ID="txtPathlevel" style="max-width:100px"/>
                        </div>
                    </div>    
                    <div class="row">
