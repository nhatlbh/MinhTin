    ...
    <script type="text/javascript" src="../../Script/Generated/Form/CatStore_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
      <div class="row"> 
   <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">Loại kho:</div>
                        <div class="input col-md-8">
                        <input placeholder="--- Chọn ---" ID="ddlStoretypeid" />
                        </div>
                    </div>    
                    <div class="row">
                        <div class="label col-md-2">Đóng kho:</div>
                        <div class="input col-md-8">
                        <input type="checkbox"  ID="chkIsclose" style='max-width:20px' />
                        </div>
                    </div>    
                    <div class="row">
