...
<script type="text/javascript" src="../../Script/Override/Form/StoExchange_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
      <div class="row"> 
   <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">Từ kho:</div>
                        <div class="input col-md-8">
                        <input placeholder="--- Chọn ---" ID="ddlFromstoreid" />
                        </div>
                    </div>    
                    <div class="row">
                        <div class="label col-md-2 required">Tới kho:</div>
                        <div class="input col-md-8">
                        <input placeholder="--- Chọn ---" ID="ddlTostoreid" />
                        </div>
                    </div>    
                    <div class="row">
