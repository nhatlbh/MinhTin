<%@ Register Src="~/UC/Reusable/PaymentDetail.ascx" TagPrefix="uc1" TagName="PaymentDetail" %>
<script type="text/javascript" src="../../../Script/Override/Form/FinMoneyslip_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
    <div class="row">
        <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">Loại chi:</div>
                        <div class="input col-md-8">
                            <input placeholder="--- Chọn ---" id="ddlPaymenttypeid" />
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-md-6">
                    <uc1:PaymentDetail runat="server" id="PaymentDetail" />
                </div>
            </div>
        </div>
    </div>
