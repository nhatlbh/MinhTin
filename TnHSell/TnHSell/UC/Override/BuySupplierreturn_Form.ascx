...
<script type="text/javascript" src="../../Script/Override/Form/BuySupplierreturn_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
    <div class="row">
        <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="label col-md-2">Phiếu nhập:</div>
                        <div class="input col-md-8">
                            <input placeholder="--- Chọn ---" id="ddlImportinvoiceid" />
                        </div>
                    </div>
                    <div class="row">
