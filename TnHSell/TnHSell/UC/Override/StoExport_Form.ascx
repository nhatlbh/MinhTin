...
<script type="text/javascript" src="../../Script/Override/Form/StoExport_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
    <div class="row">
        <div id="input" class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="label col-md-2">Lý do:</div>
                        <div class="input col-md-8" id="rdlReason"></div>
                    </div>
                    <div class="row">
