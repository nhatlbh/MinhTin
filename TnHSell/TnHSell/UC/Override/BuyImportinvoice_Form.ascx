...
<script type="text/javascript" src="../../Script/Override/Form/BuyImportinvoice_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
    <div class="row">
        <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="row">
                        <div class="label col-md-2">Nhân viên:</div>
                    ...
                    <div class="row">
                        ...
                        <div class="input col-md-8">
                            <input placeholder="--- Chọn ---" id="ddlCatStoreid" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="label col-md-2 required">Nhà cung cấp:</div>
                        <div class="input col-md-8">
                            <input placeholder="--- Chọn ---" id="ddlCatSupplierid" />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">Tổng nợ:</div>
                        <div class="input col-md-8">
