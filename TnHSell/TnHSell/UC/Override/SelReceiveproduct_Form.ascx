...
<script type="text/javascript" src="../../Script/Override/Form/SelReceiveproduct_Form.js?session='<%=Guid.NewGuid() %>'"></script>
<div class="container">
    <div class="row">
        <div id="input" class="col-md-11">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">Phiếu bán hàng:</div>
                        <div class="input col-md-8">
                            <input placeholder="--- Chọn ---" id="ddlInvoiceid" />
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">Kho:</div>
                        <div class="input col-md-8">
                    ...
                    <div class="row">
                        <div class="label col-md-2 required">Tổng tiền:</div>
                        <div class="input col-md-8">
                            <input type="text" id="txtTotal" style="max-width: 100px" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="label col-md-2">Tiền phải trả:</div>
                        <div class="input col-md-8">
                            <input type="text" id="txtTotalreturn" style="max-width: 100px" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="label col-md-2">Chiết khấu:</div>
                        <div class="input col-md-8">
                            <input type="text" id="txtDiscount" style="max-width: 100px" />
                        </div>
                    </div>
                    <div class="row">
