...
{
    public enum BuySupplierreturnDetailColumns
    {
           ID,           
           SupplierReturnID,           
           ProductID,           
    ...
    public partial class BuySupplierreturnDetailContract
    {  

    public static readonly string[] Columns = {"ID","SupplierReturnID","ProductID","Quantity","Price","VAT","OrderNum","Deleted","DeletedOn",};
