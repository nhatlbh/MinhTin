...
{
    public enum StoExchangeDetailColumns
    {
           ID,           
           ExchangeID,           
           ProductID,           
    ...
    public partial class StoExchangeDetailContract
    {  

    public static readonly string[] Columns = {"ID","ExchangeID","ProductID","Quantity","OrderNum","Deleted","DeletedOn",};
