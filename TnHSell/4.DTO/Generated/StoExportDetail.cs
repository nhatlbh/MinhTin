...
{
    public enum StoExportDetailColumns
    {
           ID,           
           ExportID,           
           ProductID,           
    ...
    public partial class StoExportDetailContract
    {  

    public static readonly string[] Columns = {"ID","ExportID","ProductID","Quantity","OrderNum","Deleted","DeletedOn",};
