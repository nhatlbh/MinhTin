...
namespace TnHSell.DTContract
{
    ...
    public partial class FinReceiptContract
    {  

    public static readonly string[] Columns = {"ID","SaleStaffID","Code","ReceiptTypeID","TotalPay","CreateDate","Description","Type","OrderNum",};
