...
namespace TnHSell.DTContract
{
    ...
    public partial class CatCodeContract
    {  

    public static readonly string[] Columns = {"ID","Code","Name","Description","NextVal","OrderNum",};
        ...
        string _nextval;
        public string Nextval { get {return _nextval!=null?_nextval:string.Empty;} set{_nextval=value;} }
        string _ordernum;
